...
using TDD.Katas.CSharp.FizzBuzzKata;

namespace TDD.Katas.CSharp.Test.Unit.FizzBuzzTests
{
    [TestFixture]
    public abstract class WhenTestingFizzBuzz
    {
        #region Protected members

        protected string _resultFizz;

        protected int ActualInputValue { get; set; }
        ...
        {
            _resultFizz = FizzBuzz.PrintFizzBuzz(ActualInputValue);
        }
